...
export const colombiaData: Record<string, string[]> = {
    "Amazonas": [
        "El Encanto", "La Chorrera", "La Pedrera", "Leticia", "Mirití-Paraná",
    ...
    "Antioquia": [
        ...
        "Angostura", "Anorí", "Anzá", "Apartadó", "Arboletes", "Argélia", "Armenia", "Barbosa",
        ...
        "Dabeiba", "Donmatías", "Ebéjico", "El Bagre", "El Carmen de Viboral", "El Peñol",
        ...
        "La Unión", "Liborina", "Maceo", "Marinilla", "Medellín", "Montebello", "Murindó", "Mutatá",
        "Nariño", "Necoclí", "Nechí", "Olaya", "Peque", "Pueblorrico", "Puerto Berrío", "Puerto Nare",
    ...
    "Bolívar": [
        ...
        "Talaigua Nuevo", "Turbaco", "Turbaná", "Villanueva", "Zambrano"
    ],
    "Boyacá": [
        ...
        "Chiquinquirá", "Chiscas", "Chita", "Chitaraque", "Chivatá", "Chivor", "Ciénega", "Cómbita",
        "Coper", "Corrales", "Covarachía", "Cubará", "Cucaita", "Cuítiva", "Duitama", "El Cocuy",
        "El Espino", "Firavitoba", "Floresta", "Gachantivá", "Gameza", "Garagoa", "Guacamayas",
        "Guateque", "Guayatá", "Güicán de la Sierra", "Iza", "Jenesano", "Jericó", "Labranzagrande",
        "La Capilla", "La Uvita", "Leiva", "Macanal", "Maripí", "Miraflores", "Mongua", "Monguí",
        "Moniquirá", "Motavita", "Muzo", "Nobsa", "Nuevo Colón", "Oicatá", "Otanche", "Pachavita",
        "Páez", "Paipa", "Pajarito", "Panqueba", "Pauna", "Paya", "Paz de Río", "Pesca", "Pisba",
        "Puerto Boyacá", "Quípama", "Ramiriquí", "Ráquira", "Rondón", "Saboyá", "Sáchica", "Samacá",
        "San Eduardo", "San José de Pare", "San Luis de Gaceno", "San Mateo", "San Miguel de Sema",
        ...
        "Somondoco", "Sora", "Soracá", "Sotaquirá", "Susacón", "Sutamarchán", "Sutatenza", "Tasco",
        "Tenza", "Tibaná", "Tibasosa", "Tinjacá", "Tipacoque", "Toca", "Togüí", "Tópaga", "Tota",
        "Tunja", "Tununguá", "Turmequé", "Tuta", "Tutazá", "Umbita", "Ventaquemada",
    ...
    "Cauca": [
        ...
        "Santander de Quilichao", "Santa Rosa", "Silvia", "Sotará", "Suárez", "Sucre", "Timbío",
    ...
    "Chocó": [
        ...
        "Medio San Juan", "Nóvita", "Nuquí", "Quibdó", "Río Iró", "Río Quito", "Riosucio",
    ...
    "Cundinamarca": [
        ...
        "Fusagasugá", "Gachalá", "Gachancipá", "Gachetá", "Gama", "Girardot", "Guachetá",
        ...
        "La Vega", "Lenguazaque", "Machetá", "Madrid", "Manta", "Medina", "Mosquera", "Nariño",
        "Nemocón", "Nilo", "Nimaima", "Nocaima", "Pacho", "Paime", "Pandi", "Paratebueno", "Pasca",
        ...
        "Ubaté", "Une", "Útica", "Venecia", "Vergara", "Vianí", "Villagómez", "Villapinzón",
        "Villeta", "Viotá", "Yacopí", "Zipacón", "Zipaquirá"
    ],
    "Guainía": [
        "Barranco Minas", "Cacahual", "Inírida", "La Guadalupe", "Mapiripana", "Morichal",
    ...
    "Magdalena": [
        ...
        "Sabanas de San Ángel", "Salamina", "San Sebastián de Buenavista", "San Zenón", "Santa Ana",
    ...
    "Meta": [
        ...
        "San Juan de Arama", "San Juanito", "San Martín", "Uribe", "Villavicencio", "Vista Hermosa"
    ],
    "Nariño": [
        "Aldana", "Ancuya", "Arboleda", "Barbacoas", "Belén", "Buesaco", "Chachagüí", "Colón",
        "Consacá", "Contadero", "Córdoba", "Cuaspúd", "Cumbal", "Cumbitara", "El Charco",
        ...
        "La Llanada", "La Tola", "La Unión", "Leiva", "Linares", "Los Andes", "Magüí Payán",
        ...
        "San Andrés de Tumaco", "San Bernardo", "San Lorenzo", "San Pablo", "San Pedro de Cartago",
        "Sandoná", "Santa Bárbara", "Santacruz", "Sapuyes", "Taminango", "Tangua", "Túquerres",
        "Yacuanquer"
    ],
    "Norte de Santander": [
        "Ábrego", "Arboledas", "Bochalema", "Bucarasica", "Cáceres del Norte", "Cachirá",
        "Chinácota", "Chitagá", "Convención", "Cúcuta", "Cucutilla", "Durania", "El Carmen",
        "El Tarra", "El Zulia", "Gramalote", "Hacarí", "Herrán", "La Esperanza", "La Playa de Belén",
    ...
    "Santander": [
        ...
        "El Playón", "Encino", "Enciso", "Floridablanca", "Florián", "Galán", "Gámbita", "Girón",
        "Guaca", "Guadalupe", "Guapotá", "Guavatá", "Güepsa", "Hato", "Jesús María", "Jordán",
        "La Belleza", "Landázuri", "La Paz", "Lebrija", "Los Santos", "Macaravita", "Málaga",
